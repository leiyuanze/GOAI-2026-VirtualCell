...
| **新集成** | **3×v2.1+v3.1** | **0.879** | 0.666 | **0.761** | **0.831** |

> 新集成（3×v2.1+v3.1）蛋白 R² 与旧集成持平，但 **FC PCC 全面提升**：val_chem 0.439→0.456、val_strain 0.342→0.351、val_both 0.227→0.238、val_time 0.597→0.610。FC PCC 对应评测 M1（原始 Fold Change，25% 权重），是扰动预测能力的核心指标。外部特征（Morgan+ESM2）的价值主要体现在提升 unseen 菌株/化合物的扰动方向预测精度。
