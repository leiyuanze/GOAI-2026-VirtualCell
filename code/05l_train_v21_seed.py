...
_spec = importlib.util.spec_from_file_location("model04", r"D:\leiyuanze\Datawhale\AI for Research\虚拟细胞\vcell\04_model_v21.py")
...
for ep in range(1, EPOCHS + 1):
    ...
    if ep % 10 == 0 or ep == EPOCHS:
        ...
        torch.save(model.state_dict(), f"{DATA}/model_v21_s{SEED}.pt")
print("\n训练完成", flush=True)
