# -*- coding: utf-8 -*-
"""
GOAI 虚拟细胞 · 07e 提交 v2.9：3×v2.1(s42/43/44) + v2.7(s42)
评估+提交，v2.7 替换 v2.5
"""
...
_s27 = importlib.util.spec_from_file_location("m29", r"D:\leiyuanze\Datawhale\AI for Research\虚拟细胞\vcell\04_model_v29.py")
_m29 = importlib.util.module_from_spec(_s27); _s27.loader.exec_module(_m29)
...
# ---------- val ----------
print(f"\n[新集成 3×v2.1+v2.9] {'场景':<16}{'样本':>5}{'RMSE':>7}{'GlobalR2':>9}{'蛋白R2中位':>10}{'FC PCC':>8}", flush=True)
