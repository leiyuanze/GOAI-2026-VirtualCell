# -*- coding: utf-8 -*-
"""
GOAI 虚拟细胞 · 07g 提交 v3.5：3×v2.1(s42/43/44) + v3.5(蛋白先验loss)
评估 + 提交，生成 prediction_ensemble8.csv (4454x4422)
"""
...
models = [
    ...
    (load_model('model_v35_best.pt', _m30.VCellModel, set_avg=True), 'v30'),
]
