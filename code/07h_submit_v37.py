# -*- coding: utf-8 -*-
"""
GOAI 虚拟细胞 · 07h 提交 v3.7：3×v2.1(s42/43/44) + v3.7(GO通路注意力)
评估 + 提交，生成 prediction_ensemble9.csv (4454x4422)
"""
...
models = [
    (load_model('model_v37_best.pt', _m37.VCellModel, set_avg=True), 'v37'),
]
print(f"[单模型] {len(models)} 模型加载完成 (v3.7 单模型)", flush=True)
