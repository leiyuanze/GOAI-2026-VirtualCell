...
输出：prediction_adaptive2.csv（4454 x 5243，log2，无 NA）
"""
...
new.to_csv(f'{DATA}/prediction_adaptive2.csv')
print(f'[提交] prediction_adaptive2.csv 生成  {new.shape}')
