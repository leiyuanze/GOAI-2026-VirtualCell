...
输出：prediction_v48.csv（4454 x 5243，log2，无 NA）
"""
...
MODELS = {
    ...
    'v48': load_model('model_v48_42_best.pt', _m37.VCellModel, set_avg=True),
}
...
new.to_csv(f'{DATA}/prediction_v48.csv')
print(f'[提交] prediction_v48.csv 生成  {new.shape}')
