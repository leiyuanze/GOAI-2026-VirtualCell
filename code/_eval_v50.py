# -*- coding: utf-8 -*-
"""
v5.0 独立评估：加载 checkpoint，四场景指标（RMSE/GlobalR2/蛋白R²中位/FC PCC）
用法：python _eval_v50.py [checkpoint_path]
FC 用全量观测对照（官方 M1 口径），训练监督对照为 train-only（脚本内自动区分）
"""
